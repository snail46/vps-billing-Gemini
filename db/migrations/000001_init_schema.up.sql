...
CREATE TABLE IF NOT EXISTS plans (
  ...
  node_group_id uuid REFERENCES node_groups(id) ON DELETE SET NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS ux_payments_gateway_external
...
CREATE UNIQUE INDEX IF NOT EXISTS ux_instance_provider_id
...
CREATE UNIQUE INDEX IF NOT EXISTS ux_port_forward
